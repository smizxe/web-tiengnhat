    ...
    return (
        <section className="py-24 relative overflow-hidden">
            ...
            <div className="pl-6 md:pl-[max(1.5rem,calc((100vw-80rem)/2))]">
                <div className="flex gap-6 overflow-x-auto hide-scrollbar snap-x snap-mandatory pb-8 pr-6">

                    {/* Course N5 */}
                    <div className="shrink-0 w-[280px] sm:w-[320px] bg-white rounded-2xl p-6 border border-black/5 snap-start hover:-translate-y-1 hover:border-[#C1121F]/30 hover:shadow-lg transition-all duration-300">
                    ...
                    {/* Course N4-N3 */}
                    <div className="shrink-0 w-[280px] sm:w-[320px] bg-white rounded-2xl p-6 border border-[#D4AF37]/30 shadow-md snap-start hover:-translate-y-1 hover:border-[#D4AF37] hover:shadow-lg transition-all duration-300 relative overflow-hidden">
                    ...
                    {/* Course N1 */}
                    <div className="shrink-0 w-[280px] sm:w-[320px] bg-white rounded-2xl p-6 border border-black/5 snap-start hover:-translate-y-1 hover:border-[#0D1B2A]/30 hover:shadow-lg transition-all duration-300">
